...
export default function LightsPage() {
  ...
  useEffect(() => {
    ...
    gui.add(hemisphere, "intensity").min(0).max(10).step(0.01);
    gui.add(hemisphere, "visible");
    ...
    gui.add(spotLight.position, "x").min(-5).max(5).step(0.01);
    gui.add(spotLight.position, "y").min(-5).max(5).step(0.01);
    gui.add(spotLight.position, "z").min(-5).max(5).step(0.01);
